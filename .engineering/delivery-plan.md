...
- Outputs: root `manifest.json`/`main.js` mirrors, `dist/obsidian-release/` assets, and Vault `.obsidian/plugins/publish-note/` runtime files; legacy `.obsidian/plugins/share-publisher/` is not removed automatically
