...
| CMP-010 | Portable Publish/Auth Core | T3 | Worker Router, console, tests | `PublishService`, `PublishStorage` | implemented locally | create | Web API/Web Crypto only；包含注册、登录、恢复、device pairing、token、quota、upload/commit/viewer |
